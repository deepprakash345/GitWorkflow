...
<Meta title="Crispr/Form Validations" component={AdaptiveForm} />
...
The default type is `string` for all fields,

<Story id="reference-json-constraints-type-string--string" />

even for number-inputs
...
<Story id="reference-json-constraints-required--required-checkbox" />
