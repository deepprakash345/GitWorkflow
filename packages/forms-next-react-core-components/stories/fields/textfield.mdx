...
<Story id="crispr-form-components-text-input-field--def" />
...
<Story id="crispr-form-components-text-input-field--with-rich-text-label" />
...
<Story id="crispr-form-components-text-input-field--with-placeholder" />

<Story id="crispr-form-components-text-input-field--with-help-text" />

Description supports HTML as well

<Story id="crispr-form-components-text-input-field--with-rich-help-text" />
...
<Story id="crispr-form-components-text-input-field--type-number" />
...
<Story id="crispr-form-components-text-input-field--number-widget" />
...
<Story id="crispr-form-components-text-input-field--type-date" />
...
<Story id="crispr-form-components-text-input-field--date-widget" />
...
<Story id="crispr-form-components-text-input-field--multi-line-widget" />
