...
<Story id="adaptive-form-dynamic-behaviour-events--change" />

Or changing the text entered on focus out

<Story id="adaptive-form-dynamic-behaviour-events--blur" />

Or Initialize

<Story id="adaptive-form-dynamic-behaviour-events--initialize" />

Or click of a button

<Story id="adaptive-form-dynamic-behaviour-events--click" />
...
<Story id="adaptive-form-dynamic-behaviour-events-custom-events--dispatch" />

Apart from that custom events can also pass an extra payload

<Story id="adaptive-form-dynamic-behaviour-events-custom-events--dispatch-with-payload" />


<Story id="adaptive-form-dynamic-behaviour-events-custom-events--fetch-data" />
