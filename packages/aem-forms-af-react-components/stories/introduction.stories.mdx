...
The [Adaptive Forms Specification](https://git.corp.adobe.com/pages/livecycle/af2-docs/spec/latest/)
...
```
npm i --save @adobe/aem-forms-af-super-component @adobe/aem-forms-af-react-components @adobe/react-spectrum @react/react-spectrum
```
